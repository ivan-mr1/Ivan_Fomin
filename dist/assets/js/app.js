...
const L = () => d,
  ...
  x = () => document.querySelectorAll('[data-right-padding]'),
  k = () => {
...
const M = (i) => i / 16,
  m = { mobile: window.matchMedia(`(width <= ${M(767.98)}rem)`) };
class H {
  hiddenHeader = !0;
  selectors = {
    root: '[data-header]',
...
let E = (i, t = 500) => {
  ...
  _ = (i, t = 500) => (i.hidden ? I(i, t) : E(i, t));
class g {
  constructor(t) {
    ((this.rootElement = t),
...
class O {
  ...
  init() {
    ...
    (t.forEach((o) => {
      ...
      e.forEach((o) => {
        (o.classList.add('init'), this.spollers.set(o, new g(o)));
      }),
            ...
            s.forEach((r) => {
              n.matches
                ? (r.classList.add('init'),
                  this.spollers.has(r) || this.spollers.set(r, new g(r)))
...
class $ {
  ...
  createLink() {
    ...
    return (
      ...
      (t.dataset.image = this.getImagePath()),
...
class y extends p {
  ...
  createProjectCard(t) {
    return new $(t).renderElement();
  }
  createShowMoreButton() {
    return (
      this.showMoreButton ||
        (this.showMoreButton = new R({
...
window.addEventListener('DOMContentLoaded', () => {
  (T(), new H(), new O(), D(), new B(), new V(), new q(), new W(), G());
});
